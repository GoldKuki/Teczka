...
from loginSystem import views as ls_views

urlpatterns = [
    path('admin/', admin.site.urls),
    path('profile/', ls_views.profile, name='profile'),
    path('register/', ls_views.register, name='register'),
